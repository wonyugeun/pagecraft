                ...
                {displayHistory.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ width: 72, height: 56, flexShrink: 0, background: bg, borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 26, overflow: 'hidden' }}>
