    ...
    return (
      <div className="gen-shell">
        ...
        <div style={{ fontSize: 13, color: '#666', lineHeight: 1.8, marginBottom: 32, textAlign: 'center' }}>
          상세페이지 생성에 <b>{calculateGenerationCost({ sectionCount: secCnt, baseSectionCount: structureForCount, out })} 크레딧</b>이 필요해요
        </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          판매 전략을 세우고 → 섹션 구조를 짜고 → <b style={{ color: '#333' }}>섹션마다 카피를 따로</b> 씁니다.<br />
          한 번에 몰아 쓰면 여덟 섹션이 서로 비슷해져요. 같은 자랑이 반복되고, 어느 섹션도
          제 역할을 못 합니다.<br />
          그래서 섹션마다 <b style={{ color: '#333' }}>무슨 일을 맡을지 정해두고 따로</b> 씁니다 —
          공감할 자리는 공감만, 근거를 댈 자리는 근거만.<br />
          그만큼 시간이 걸려요. 8섹션 기준 보통 5분 안팎입니다.<br />
