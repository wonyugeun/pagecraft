...
- 결과 화면에서 섹션별 이미지 재생성과 카피 직접 수정이 가능하고, 수정은 자동 저장됩니다. 이미지 재생성 무료 장수는 생성 규모에 비례합니다(16섹션 생성이면 10장, 32섹션이면 20장). 빠른제작·썸네일처럼 1섹션짜리는 무료 재생성이 없어요. 무료분을 다 쓰면 1장당 1크레딧이 차감됩니다(차감 전에 항상 확인 창이 떠요). 지난 작업은 대시보드 히스토리에서 다시 열 수 있습니다.

[크레딧·요금]
- 신규 가입 시 체험 크레딧 10개(유효기간 7일)(상세페이지 1회 분량). 생성은 섹션 1개당 1크레딧 차감.
