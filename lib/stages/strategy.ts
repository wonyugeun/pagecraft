...
[출력 형식 — 아래 JSON 객체 하나만 출력. 다른 텍스트·설명·마크다운·코드펜스 금지]
{
  ...
  "strategy": {
    ...
    "tone": "이 제품·고객에 가장 맞는 화법 하나. 아래 10종 중 선택 — ⚠️'신뢰형'은 애매할 때 고르는 기본값이 아닙니다. 상품 성격상 분명히 맞을 때만 고르고, 그 외에는 더 구체적인 화법을 고르세요: 전문가형(근거·데이터로 설득) / 신뢰형(안전·검증 강조) / 감성형(장면·정서 중심) / 데이터형(수치·비교 전면) / 직설형(군더더기 없이 단언) / 스토리형(만든 사람·과정 서사) / 다정형(돌봄·안심시키는 말투) / 유쾌형(가볍고 위트 있게, 과장·말장난은 금지) / 미니멀형(짧은 문장·여백, 절제된 표현) / 실용형(사용 상황·활용법 중심). 같은 카테고리라도 제품 포지션이 다르면 tone도 달라져야 합니다",
    "speech_level": "문장 어투 하나 — 해요체(친근한 존댓말, ~해요/~어요) / 합니다체(정중·전문적, ~합니다/~습니다) / 단정형(~다체. 광고 카피처럼 짧고 단단하게: '매일 아침이 달라진다') / 명사형(체언 종결로 절제: '하루 한 알로 끝.') / 반말친근체(20대 타겟·캐주얼 브랜드에 한해, 무례하지 않게). ⚠️'해요체'가 기본값이 아닙니다 — 타겟 연령·브랜드 포지션·카테고리를 보고 고르세요(프리미엄·미니멀 → 단정형/명사형, 전문·의료 인접 → 합니다체, 생활밀착·육아 → 해요체). 혼용은 금지",
