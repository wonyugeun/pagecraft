...
2. 대화체: 보고서·소개서 말투 금지. 말 거는 대화체로. "있으시죠? / 해보셨나요? / 그런 날 없으셨나요? / 사실은 / 괜찮을까 / ~거예요" 같은 표현을 자연스럽게 섞으세요.
...
- ⭐후기/리뷰 섹션 — ⚠️전 카테고리 공통 법적 필수(표시광고법 / 공정위, 가짜 후기는 과징금 대상). 카테고리(화장품·식품·패션·가전·반려동물·건강 등) 무관하게 동일 적용:
   ...
   · body 끝에 안내 한 줄: "💡 실제 후기를 입력하면 이 섹션이 훨씬 강력해집니다". ⚠️이 안내는 후기가 '미입력'일 때만 씁니다 — 셀러가 후기를 입력했다면 절대 붙이지 마세요(고객에게 노출되는 문구입니다).
