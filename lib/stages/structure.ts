...
[출력 형식 — 아래 JSON 객체 하나만. 다른 텍스트·설명·마크다운·코드펜스 금지]
{
  ...
  "sections": [
    { "name": "섹션 이름(12자 이내 역할명)", "role": "이 섹션의 역할", "mission": "이 제품의 전략/main_weapon을 어떤 각도로 수행하는지 한 줄", "emotion_goal": "이 섹션을 읽고 독자가 속으로 느껴야 할 한 문장 (독자의 1인칭 속마음)", "writing_style": "이 섹션을 쓸 말하는 방식 한 줄 (예: 친구가 말하듯 질문·대화체 / 선언형 짧고 강한 문장 / 계산형 숫자 중심 등)" }
  ]
}`;
